...
module e203_dec_regfile(
  ...
  // wire flag_1idx = ( read_src1_idx == wbck_dest_idx )  & wbck_dest_wen;
  // wire flag_2idx = ( read_src2_idx == wbck_dest_idx )  & wbck_dest_wen;

  // assign read_src1_dat = flag_1idx ? wbck_dest_dat : rf_r[read_src1_idx];
  // assign read_src2_dat = flag_2idx ? wbck_dest_dat : rf_r[read_src2_idx]; 

  assign read_src1_dat = rf_r[read_src1_idx];
  assign read_src2_dat = rf_r[read_src2_idx]; 
  assign rf2ifu_rs1 = rf_r[i_rs1idx];
