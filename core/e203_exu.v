...
module e203_exu(
  ...
  wire  longp_wbck_o_valid_nxt; // Handshake valid 
  wire  [`E203_FLEN-1:0] longp_wbck_o_wdat_nxt;
  wire  [5-1:0] longp_wbck_o_flags_nxt;
  wire  [`E203_RFIDX_WIDTH-1:0] longp_wbck_o_rdidx_nxt;
  wire  longp_wbck_o_rdfpu_nxt;
  ...
  e203_exu_longpwbck u_e203_exu_longpwbck(
    ...
    .longp_wbck_o_valid   (longp_wbck_o_valid_nxt ), 
    .longp_wbck_o_ready   (longp_wbck_o_ready ),
    .longp_wbck_o_wdat    (longp_wbck_o_wdat_nxt  ),
    .longp_wbck_o_rdidx   (longp_wbck_o_rdidx_nxt ),
    .longp_wbck_o_rdfpu   (longp_wbck_o_rdfpu_nxt ),
    .longp_wbck_o_flags   (longp_wbck_o_flags_nxt ),
  ...
  // wire  exu_o_valid_nxt = (alu_wbck_o_valid_nxt | longp_wbck_o_valid_nxt) & i_valid ;
  ...
  // wire  longp_wbck_o_valid_ena = longp_wbck_o_ready;
  // wire  longp_wbck_o_wdat_ena = longp_wbck_o_ready;
  // wire  longp_wbck_o_flags_ena = longp_wbck_o_ready;
  // wire  longp_wbck_o_rdidx_ena = longp_wbck_o_ready;
  // wire  longp_wbck_o_rdfpu_ena = longp_wbck_o_ready;

  // wire  exu_o_valid_ena = exu_o_ready;
  ...
  // wire  longp_wbck_o_valid_r; 
  // wire  [`E203_FLEN-1:0] longp_wbck_o_wdat_r;
  // wire  [5-1:0] longp_wbck_o_flags_r;
  // wire  [`E203_RFIDX_WIDTH-1:0] longp_wbck_o_rdidx_r;
  // wire  longp_wbck_o_rdfpu_r;
  ...
  // sirv_gnrl_dfflr #(1) longp_wbck_o_vali_dfflr (longp_wbck_o_valid_ena, longp_wbck_o_valid_nxt, longp_wbck_o_valid_r, clk, rst_n);
  // sirv_gnrl_dfflr #(`E203_FLEN) longp_wbck_o_wdat_dfflr (longp_wbck_o_wdat_ena, longp_wbck_o_wdat_nxt, longp_wbck_o_wdat_r, clk, rst_n);
  // sirv_gnrl_dfflr #(5) longp_wbck_o_flags_dfflr (longp_wbck_o_flags_ena, longp_wbck_o_flags_nxt, longp_wbck_o_flags_r, clk, rst_n);
  // sirv_gnrl_dfflr #(`E203_RFIDX_WIDTH) longp_wbck_o_rdidx_dfflr (longp_wbck_o_rdidx_ena, longp_wbck_o_rdidx_nxt, longp_wbck_o_rdidx_r, clk, rst_n);
  // sirv_gnrl_dfflr #(1) longp_wbck_o_rdfpu_dfflr (longp_wbck_o_rdfpu_ena, longp_wbck_o_rdfpu_nxt, longp_wbck_o_rdfpu_r, clk, rst_n);

  // sirv_gnrl_dfflr #(1) exu_i_valid_dfflr (exu_o_valid_ena, exu_o_valid_nxt, exu_o_valid_r, clk, rst_n);
  ...
  // assign longp_wbck_o_valid = longp_wbck_o_valid_r; 
  // assign longp_wbck_o_wdat = longp_wbck_o_wdat_r;  
  // assign longp_wbck_o_flags = longp_wbck_o_flags_r;
  // assign longp_wbck_o_rdidx = longp_wbck_o_rdidx_r;
  // assign longp_wbck_o_rdfpu = longp_wbck_o_rdfpu_r;

  // assign exu_o_valid =  exu_o_valid_r;  

  assign alu_wbck_o_valid =  alu_wbck_o_valid_nxt;
  assign alu_wbck_o_wdat = alu_wbck_o_wdat_nxt;
  assign alu_wbck_o_rdidx = alu_wbck_o_rdidx_nxt;

  assign longp_wbck_o_valid = longp_wbck_o_valid_nxt; 
  assign longp_wbck_o_wdat = longp_wbck_o_wdat_nxt;  
  assign longp_wbck_o_flags =  longp_wbck_o_flags_nxt;
  assign longp_wbck_o_rdidx =  longp_wbck_o_rdidx_nxt;
  assign longp_wbck_o_rdfpu =   longp_wbck_o_rdfpu_nxt;
  // assign exu_o_valid =  exu_o_valid_nxt;   
